...
export declare abstract class GelSelectQueryBuilderBase<THKT extends GelSelectHKTBase, TTableName extends string | undefined, TSelection extends ColumnsSelection, TSelectMode extends SelectMode, TNullabilityMap extends Record<string, JoinNullability> = TTableName extends string ? Record<TTableName, 'not-null'> : {}, TDynamic extends boolean = false, TExcludedMethods extends string = never, TResult extends any[] = SelectResult<TSelection, TSelectMode, TNullabilityMap>[], TSelectedFields extends ColumnsSelection = BuildSubquerySelection<TSelection, TNullabilityMap>> extends TypedQueryBuilder<TSelectedFields, TResult> {
     ...
     * ```
     */
    rightJoin: <TJoinedTable extends SQL<unknown> | Subquery<string, Record<string, unknown>> | GelTable<import("drizzle-orm/gel-core/table").TableConfig> | GelViewBase<string, boolean, ColumnsSelection>, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TJoinedTable, on: SQL<unknown> | ((aliases: this["_"]["selection"]) => SQL | undefined) | undefined) => import("drizzle-orm/gel-core/query-builders/select.types").GelSelectJoin<this, TDynamic, "right", TJoinedTable, TJoinedName>;
    /**
     ...
     * ```
     */
    innerJoin: <TJoinedTable extends SQL<unknown> | Subquery<string, Record<string, unknown>> | GelTable<import("drizzle-orm/gel-core/table").TableConfig> | GelViewBase<string, boolean, ColumnsSelection>, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TJoinedTable, on: SQL<unknown> | ((aliases: this["_"]["selection"]) => SQL | undefined) | undefined) => import("drizzle-orm/gel-core/query-builders/select.types").GelSelectJoin<this, TDynamic, "inner", TJoinedTable, TJoinedName>;
    /**
     ...
     * ```
     */
    fullJoin: <TJoinedTable extends SQL<unknown> | Subquery<string, Record<string, unknown>> | GelTable<import("drizzle-orm/gel-core/table").TableConfig> | GelViewBase<string, boolean, ColumnsSelection>, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TJoinedTable, on: SQL<unknown> | ((aliases: this["_"]["selection"]) => SQL | undefined) | undefined) => import("drizzle-orm/gel-core/query-builders/select.types").GelSelectJoin<this, TDynamic, "full", TJoinedTable, TJoinedName>;
    /**
     ...
     * ```
     */
    crossJoin: <TJoinedTable extends SQL<unknown> | Subquery<string, Record<string, unknown>> | GelTable<import("drizzle-orm/gel-core/table").TableConfig> | GelViewBase<string, boolean, ColumnsSelection>, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TJoinedTable) => import("drizzle-orm/gel-core/query-builders/select.types").GelSelectJoin<this, TDynamic, "cross", TJoinedTable, TJoinedName>;
    /**

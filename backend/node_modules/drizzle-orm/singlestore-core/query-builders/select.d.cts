...
export declare abstract class SingleStoreSelectQueryBuilderBase<THKT extends SingleStoreSelectHKTBase, TTableName extends string | undefined, TSelection extends ColumnsSelection, TSelectMode extends SelectMode, TPreparedQueryHKT extends PreparedQueryHKTBase, TNullabilityMap extends Record<string, JoinNullability> = TTableName extends string ? Record<TTableName, 'not-null'> : {}, TDynamic extends boolean = false, TExcludedMethods extends string = never, TResult extends any[] = SelectResult<TSelection, TSelectMode, TNullabilityMap>[], TSelectedFields extends ColumnsSelection = BuildSubquerySelection<TSelection, TNullabilityMap>> extends TypedQueryBuilder<TSelectedFields, TResult> {
     ...
     * ```
     */
    leftJoin: <TJoinedTable extends SQL<unknown> | Subquery<string, Record<string, unknown>> | SingleStoreTable<import("drizzle-orm/singlestore-core/table").TableConfig>, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TJoinedTable, on: SQL<unknown> | ((aliases: this["_"]["selection"]) => SQL | undefined) | undefined) => import("drizzle-orm/singlestore-core/query-builders/select.types").SingleStoreJoin<this, TDynamic, "left", TJoinedTable, TJoinedName>;
    /**
     ...
     * ```
     */
    rightJoin: <TJoinedTable extends SQL<unknown> | Subquery<string, Record<string, unknown>> | SingleStoreTable<import("drizzle-orm/singlestore-core/table").TableConfig>, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TJoinedTable, on: SQL<unknown> | ((aliases: this["_"]["selection"]) => SQL | undefined) | undefined) => import("drizzle-orm/singlestore-core/query-builders/select.types").SingleStoreJoin<this, TDynamic, "right", TJoinedTable, TJoinedName>;
    /**
     ...
     * ```
     */
    innerJoin: <TJoinedTable extends SQL<unknown> | Subquery<string, Record<string, unknown>> | SingleStoreTable<import("drizzle-orm/singlestore-core/table").TableConfig>, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TJoinedTable, on: SQL<unknown> | ((aliases: this["_"]["selection"]) => SQL | undefined) | undefined) => import("drizzle-orm/singlestore-core/query-builders/select.types").SingleStoreJoin<this, TDynamic, "inner", TJoinedTable, TJoinedName>;
    /**
     ...
     * ```
     */
    fullJoin: <TJoinedTable extends SQL<unknown> | Subquery<string, Record<string, unknown>> | SingleStoreTable<import("drizzle-orm/singlestore-core/table").TableConfig>, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TJoinedTable, on: SQL<unknown> | ((aliases: this["_"]["selection"]) => SQL | undefined) | undefined) => import("drizzle-orm/singlestore-core/query-builders/select.types").SingleStoreJoin<this, TDynamic, "full", TJoinedTable, TJoinedName>;
    /**
     ...
     * ```
     */
    crossJoin: <TJoinedTable extends SQL<unknown> | Subquery<string, Record<string, unknown>> | SingleStoreTable<import("drizzle-orm/singlestore-core/table").TableConfig>, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TJoinedTable) => import("drizzle-orm/singlestore-core/query-builders/select.types").SingleStoreJoin<this, TDynamic, "cross", TJoinedTable, TJoinedName>;
    /**
     ...
     */
    crossJoinLateral: <TJoinedTable extends SQL<unknown> | Subquery<string, Record<string, unknown>>, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TJoinedTable) => import("drizzle-orm/singlestore-core/query-builders/select.types").SingleStoreJoin<this, TDynamic, "cross", TJoinedTable, TJoinedName>;

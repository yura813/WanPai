...
export declare abstract class SQLiteSelectQueryBuilderBase<THKT extends SQLiteSelectHKTBase, TTableName extends string | undefined, TResultType extends 'sync' | 'async', TRunResult, TSelection extends ColumnsSelection, TSelectMode extends SelectMode, TNullabilityMap extends Record<string, JoinNullability> = TTableName extends string ? Record<TTableName, 'not-null'> : {}, TDynamic extends boolean = false, TExcludedMethods extends string = never, TResult extends any[] = SelectResult<TSelection, TSelectMode, TNullabilityMap>[], TSelectedFields extends ColumnsSelection = BuildSubquerySelection<TSelection, TNullabilityMap>> extends TypedQueryBuilder<TSelectedFields, TResult> {
     ...
     * ```
     */
    rightJoin: <TJoinedTable extends SQLiteTable | Subquery | SQLiteViewBase | SQL, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TJoinedTable, on: SQL<unknown> | ((aliases: this["_"]["selection"]) => SQL | undefined) | undefined) => import("drizzle-orm/sqlite-core/query-builders/select.types").SQLiteSelectJoin<this, TDynamic, "right", TJoinedTable, TJoinedName>;
    /**
     ...
     * ```
     */
    innerJoin: <TJoinedTable extends SQLiteTable | Subquery | SQLiteViewBase | SQL, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TJoinedTable, on: SQL<unknown> | ((aliases: this["_"]["selection"]) => SQL | undefined) | undefined) => import("drizzle-orm/sqlite-core/query-builders/select.types").SQLiteSelectJoin<this, TDynamic, "inner", TJoinedTable, TJoinedName>;
    /**
     ...
     * ```
     */
    fullJoin: <TJoinedTable extends SQLiteTable | Subquery | SQLiteViewBase | SQL, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TJoinedTable, on: SQL<unknown> | ((aliases: this["_"]["selection"]) => SQL | undefined) | undefined) => import("drizzle-orm/sqlite-core/query-builders/select.types").SQLiteSelectJoin<this, TDynamic, "full", TJoinedTable, TJoinedName>;
    /**
     ...
     * ```
     */
    crossJoin: <TJoinedTable extends SQLiteTable | Subquery | SQLiteViewBase | SQL, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TJoinedTable) => import("drizzle-orm/sqlite-core/query-builders/select.types").SQLiteSelectJoin<this, TDynamic, "cross", TJoinedTable, TJoinedName>;

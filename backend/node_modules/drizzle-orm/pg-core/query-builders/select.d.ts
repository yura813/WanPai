...
export declare abstract class PgSelectQueryBuilderBase<THKT extends PgSelectHKTBase, TTableName extends string | undefined, TSelection extends ColumnsSelection, TSelectMode extends SelectMode, TNullabilityMap extends Record<string, JoinNullability> = TTableName extends string ? Record<TTableName, 'not-null'> : {}, TDynamic extends boolean = false, TExcludedMethods extends string = never, TResult extends any[] = SelectResult<TSelection, TSelectMode, TNullabilityMap>[], TSelectedFields extends ColumnsSelection = BuildSubquerySelection<TSelection, TNullabilityMap>> extends TypedQueryBuilder<TSelectedFields, TResult> {
     ...
     * ```
     */
    leftJoin: <TJoinedTable extends SQL<unknown> | Subquery<string, Record<string, unknown>> | PgTable<import("drizzle-orm/pg-core/table").TableConfig> | PgViewBase<string, boolean, ColumnsSelection>, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TableLikeHasEmptySelection<TJoinedTable> extends true ? DrizzleTypeError<"Cannot reference a data-modifying statement subquery if it doesn't contain a `returning` clause"> : TJoinedTable, on: SQL<unknown> | ((aliases: this["_"]["selection"]) => SQL | undefined) | undefined) => import("drizzle-orm/pg-core/query-builders/select.types").PgSelectJoin<this, TDynamic, "left", TJoinedTable, TJoinedName>;
    /**
     ...
     * ```
     */
    rightJoin: <TJoinedTable extends SQL<unknown> | Subquery<string, Record<string, unknown>> | PgTable<import("drizzle-orm/pg-core/table").TableConfig> | PgViewBase<string, boolean, ColumnsSelection>, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TableLikeHasEmptySelection<TJoinedTable> extends true ? DrizzleTypeError<"Cannot reference a data-modifying statement subquery if it doesn't contain a `returning` clause"> : TJoinedTable, on: SQL<unknown> | ((aliases: this["_"]["selection"]) => SQL | undefined) | undefined) => import("drizzle-orm/pg-core/query-builders/select.types").PgSelectJoin<this, TDynamic, "right", TJoinedTable, TJoinedName>;
    /**
     ...
     * ```
     */
    innerJoin: <TJoinedTable extends SQL<unknown> | Subquery<string, Record<string, unknown>> | PgTable<import("drizzle-orm/pg-core/table").TableConfig> | PgViewBase<string, boolean, ColumnsSelection>, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TableLikeHasEmptySelection<TJoinedTable> extends true ? DrizzleTypeError<"Cannot reference a data-modifying statement subquery if it doesn't contain a `returning` clause"> : TJoinedTable, on: SQL<unknown> | ((aliases: this["_"]["selection"]) => SQL | undefined) | undefined) => import("drizzle-orm/pg-core/query-builders/select.types").PgSelectJoin<this, TDynamic, "inner", TJoinedTable, TJoinedName>;
    /**
     ...
     * ```
     */
    fullJoin: <TJoinedTable extends SQL<unknown> | Subquery<string, Record<string, unknown>> | PgTable<import("drizzle-orm/pg-core/table").TableConfig> | PgViewBase<string, boolean, ColumnsSelection>, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TableLikeHasEmptySelection<TJoinedTable> extends true ? DrizzleTypeError<"Cannot reference a data-modifying statement subquery if it doesn't contain a `returning` clause"> : TJoinedTable, on: SQL<unknown> | ((aliases: this["_"]["selection"]) => SQL | undefined) | undefined) => import("drizzle-orm/pg-core/query-builders/select.types").PgSelectJoin<this, TDynamic, "full", TJoinedTable, TJoinedName>;
    /**
     ...
     * ```
     */
    crossJoin: <TJoinedTable extends SQL<unknown> | Subquery<string, Record<string, unknown>> | PgTable<import("drizzle-orm/pg-core/table").TableConfig> | PgViewBase<string, boolean, ColumnsSelection>, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TableLikeHasEmptySelection<TJoinedTable> extends true ? DrizzleTypeError<"Cannot reference a data-modifying statement subquery if it doesn't contain a `returning` clause"> : TJoinedTable) => import("drizzle-orm/pg-core/query-builders/select.types").PgSelectJoin<this, TDynamic, "cross", TJoinedTable, TJoinedName>;
    /**
     ...
     */
    crossJoinLateral: <TJoinedTable extends SQL<unknown> | Subquery<string, Record<string, unknown>>, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TableLikeHasEmptySelection<TJoinedTable> extends true ? DrizzleTypeError<"Cannot reference a data-modifying statement subquery if it doesn't contain a `returning` clause"> : TJoinedTable) => import("drizzle-orm/pg-core/query-builders/select.types").PgSelectJoin<this, TDynamic, "cross", TJoinedTable, TJoinedName>;
